...
5. （v0.1.3）创作层默认开启：`[narrative] life_fragment_interval_minutes = 120`（生活片段生成间隔，分钟）、`life_fragment_daily_max = 6`（每日上限）。间隔越短、上限越高，主动消息由头越"有生活"，token 成本也越高。（2026-09-21 由 240/3 放宽：实测创作层仅占 token 总量 ~0.1%，原值过度保守。）
